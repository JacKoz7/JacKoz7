...
if __name__ == '__main__':
    """
    Jacek Kozlowski (JacKoz7)
    Based on github-stats-terminal-style by Andrew Grant (Andrew6rant)
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 9, 12))
